...
#             text_path = '_'.join(wav_path.replace('wav', 'text_10_4_2').split('_')[:-1])+'.csv'
...
#         kana_.append(kanas[i]+['[PAD]']*(max_len-l1))
    ...
    return chs, text_, kanas, idxs, vad_, turn_, last_ipu_, target_, feat_, input_lengths, offsets, indices, is_barge_in, #wav_, wav_lengths, wav_paths
