...
#         self.idx_dict = idx_dict
    ...
    #             turn_agent = np.ones(len(turn_agent)) - turn_agent
            ...
            name = kana_path.split('/')[-1].replace('.csv', '')
...
def collate_fn(batch):
    chs, offsets, is_barge_in, texts, kanas, feat_paths, wav_paths, vad, turn, last_ipu, targets, feats, indices = zip(*batch)
    ...
    return chs, text_, kana_, vad_, turn_, last_ipu_, target_, feat_, input_lengths, offsets, indices, is_barge_in, #wav_, wav_lengths, wav_paths
