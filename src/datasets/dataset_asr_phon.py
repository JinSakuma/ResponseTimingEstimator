...
#             )
    ...
    def __getitem__(self, index):
        ...
        batch['phoneme'] = self.data['phoneme'].iloc[index]
        idx_str = self.data['idx'].iloc[index]
...
def collate_fn(batch, pad_idx=46):
    texts, phonemes, idxs, feats, indices = zip(*batch)
    ...
    return feat_, input_lengths, idxs_, target_lengths, indices, texts, phonemes
