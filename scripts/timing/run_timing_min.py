...
def run(args):
    ...
    train_dataset = get_dataset(config, 'train', ['M1'], scale=config.data_scale)
    val_dataset = get_dataset(config, 'valid', ['M1'], scale=1)
