...
for split in ['train', 'valid', 'test']:
    ...
    info = {'file_id': [], 'file_name': [], 'is_removed' :[], 'text': [], 'kana': [], 'kana_idx': [],
            'phoneme': [], 'phoneme_idx': [], 'feat_path' : [], 'spk': []}
    ...
    for i, line in enumerate(tqdm(lines)):
        ...
        try:        
            ...
            phonemes = jaconv.hiragana2julius(hiragana)
            ...
            idx_kana = hiragana2idx(hiragana)
            idx_phon = phon2idx(phonemes)                        
        ...
        info['kana'].append(hiragana)
        info['kana_idx'].append(idx_kana)
        info['phoneme'].append(phonemes)
        info['phoneme_idx'].append(idx_phon)        
