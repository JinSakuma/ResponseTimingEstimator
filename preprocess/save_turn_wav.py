...
# root='/mnt/aoni04/jsakuma/data/ATR-Fujie/samples1124/'
root='/mnt/aoni04/jsakuma/data/ATR-Fujie/samples1212/'
offset = 200
sys_duration = 3000
...
#             end=min(next_sys_uttr_end, next_sys_uttr_start+sys_duration)
            end_=min(next_sys_uttr_end, next_sys_uttr_start+sys_duration)
            end=max(end_, cur_usr_uttr_end)
