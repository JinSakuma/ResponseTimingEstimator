    ...
    # for split in ['val', 'test']:
        for batch in tqdm(loader_dict[split]):
            ...
            for i in range(batch_size):
                ...
                os.makedirs('/mnt/aoni04/jsakuma/data/ATR-Fujie/samples/kana2/{}'.format(dir_name), exist_ok=True)
                df_path = '/mnt/aoni04/jsakuma/data/ATR-Fujie/samples/kana2/{}/{}.csv'.format(dir_name, file_name)
