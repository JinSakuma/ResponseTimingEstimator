    ...
    # for split in ['val', 'test']:
        for batch in tqdm(loader_dict[split]):
            ...
            for i in range(batch_size):
                ...
                if dir_name != '20131119-6_04':
                    continue
                
                file_name = '_'.join(name_part)
                
                os.makedirs('/mnt/aoni04/jsakuma/data/ATR-Fujie/samples/kana/{}'.format(dir_name), exist_ok=True)
                df_path = '/mnt/aoni04/jsakuma/data/ATR-Fujie/samples/kana/{}/{}.csv'.format(dir_name, file_name)
